      ...
      <div className="container">
            ...
            <ul className="task-list">
              <li className="task-item">
                ...
                <div>
                  ...
                  Start with <a href="https://aiupskill.net/courses" target="_blank">AIUpskill.net</a> courses specific to your industry
                </div>
              </li>
              <li className="task-item">
                ...
                <div>
                  ...
                  Connect with <a href="https://vibestl.ai" target="_blank">VibeSTL.ai</a> community for local support
                </div>
              </li>
              <li className="task-item">
            ...
            <ul className="task-list">
              <li className="task-item">
                ...
                <div>
                  ...
                  Earn credentials from <a href="https://aiupskill.net/certifications" target="_blank">AIUpskill.net</a>
                </div>
              </li>
              <li className="task-item">
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '2rem', margin: '2rem 0', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
          ...
          <ul style={{ margin: '1rem 0', paddingLeft: '2rem' }}>
            ...
            <li><a href="https://jessecamplion.ai/case-studies/financial-analyst" target="_blank">Financial Analyst → AI Risk Consultant</a></li>
          </ul>
        </div>
      </div>
      <StructuredData data={createArticleSchema(
        "AI Career Transition Guide",
        "90‑day AI career transition guide.",
        "https://inversedisplacement.com/ai-career-transition-guide/",
        undefined,
        "Jesse Campbell",
        "2024-12-19",
        "2024-12-19"
